...
export function editView(furniture)
{
    currentFurniture = furniture;
    history.pushState({}, '', '/edit');
    render(edit(furniture), container);
}
...
async function onSubmit(e)
{
    ...
    await furnitureService.editFurniture(data, currentFurniture._id);
    e.target.reset();
